...
This result indicates that 48.43% of the sample population voted to
remain in the EU while 40.68% voted to leave the EU. We can then
therefore presume that the majority of the sample population that falls
under NA voted to leave since the results of the referendum according to
the BBC was 51.9% leave and 48.1% remain.
...
From these results we can see that younger voters tended to vote remain
(72.64% of females 16-25 voted remain), while older voters tended to
vote leave (44.24% of females over 70 voted remain). We can also see
that more females tended to vote remain than men, since in every age
category, the percentage of remain vote was higher for females than
males.
